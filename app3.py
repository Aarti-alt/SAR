...
# Creating header
    col1,col2 = st.columns(2)
    with col1:
        st.markdown("""<span style="font-size: 22px; ">Pre-Set Questionnaire</span>""", unsafe_allow_html=True)
    ...
    # Text Input
    st.markdown("""<span style="font-size: 22px; ">Ask Additional Questions</span>""", unsafe_allow_html=True)
